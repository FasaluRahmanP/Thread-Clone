  ...
  return (
    <nav className='bg-[0a0a0a] h-full w-20 fixed'>
      <div className='flex flex-col items-center h-full py-4'>
        ...
        {dropdownOpen && (
          <div className="fixed bottom-16 ml-48 bg-[#212121] text-[#F3F5F7] mt-2 px-10 rounded-2xl text-start ">
            <ul>
              <li className="hover:bg-[#be3333] cursor-pointer">Appearance</li>
              <li className=" hover:bg-gray-700 cursor-pointer">Insight</li>
              <li className=" hover:bg-gray-700 cursor-pointer">Settings</li>
              <li className=" hover:bg-gray-700 cursor-pointer">Report a problem</li>
              <li className=" hover:bg-gray-700 cursor-pointer">Log out</li>
            </ul>
          </div>
        )}
        {/* </div> */}
